...
public class MissionsByLevel {
    ...
    private static void initializeMissions() {
        missions.put(Level.LEVEL1, Arrays.asList(new Mission("자동차경주"),new Mission("로또"),new Mission("지하철노선도")));
        missions.put(Level.LEVEL2,Arrays.asList(new Mission("장바구니"),new Mission("결제"),new Mission("지하철노선도")));
